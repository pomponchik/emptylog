...
class PrintingLogger(AbstractLogger):
    ...
    def debug(self, message: str, *args: Any, **kwargs: Any) -> None:  # noqa: ARG002
    ...
    def warning(self, message: str, *args: Any, **kwargs: Any) -> None:  # noqa: ARG002
        self.callback(self.create_line('WARNING', message))

    def error(self, message: str, *args: Any, **kwargs: Any) -> None:  # noqa: ARG002
        self.callback(self.create_line('ERROR', message))

    def exception(self, message: str, *args: Any, **kwargs: Any) -> None:  # noqa: ARG002
        self.callback(self.create_line('EXCEPTION', message))

    def critical(self, message: str, *args: Any, **kwargs: Any) -> None:  # noqa: ARG002
